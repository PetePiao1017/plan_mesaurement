import { Button, Modal, Form, Input, Typography, InputNumber, Popconfirm } from "antd";
...
export default connect(mapStateToProps, {retrieveData, createCategory, deleteCategory, EditSubCategoryById})(Admin)
